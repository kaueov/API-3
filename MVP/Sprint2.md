...
- Nesta etapa foi realizado o primeiro dashboard apresentando dados de 2015 até 2025
- Foi feito o levantamento dos principais tipos de veículos envolvidos em acidentes e a gravidade dos acidentes


---

## 📝 Descrição da Solução 
- Dashboard interativo apresentando de forma gráfica dados relacionados aos acidentes, como tipo de via, localização, tipo de veículo e gravidade do acidente 
...
| 03     | Dashboard funcional                      | Concluído |
---

## 📊 Critérios de Aceitação
- O MVP deve permitir que o usuário entenda os passos e o planejamento até a entrega do dashboard os dados que pretende apresentar
- O sistema deve registrar a os dados apresentados no dashboard e o grande volume de dados relacionados aos sinistros de trânsito
...
- Conclusões que podemos tirar com esses dados

---

## 🚀 Próximos Passos
- Melhorias planejadas após feedback  
- Lapidação do dashboard para atender melhor as necessidades do cliente
- Expansão de funcionalidades para próximo incremento  

---

## 📂 Anexos / Evidências
 ![MVP 2](../Imagens/MVP2.gif)

 <img width=100% src="Imagens/MVP2.gif">
